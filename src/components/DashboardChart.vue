...
<div class="column justify-center">
  <div class="row items-center q-ma-sm" style="max-height: 40px" v-for="(info, index) in infos" :key="info.places">
    ...
    <div style="width: 80%">
      <div @mouseover="changeStatusToTrue(index)" @mouseleave="changeStatusToFalse(index)" class="column justify-center text-right" v-bind:style="{ width: getSize(info.places) + '%', height: '40px', backgroundColor: '#3CB371', opacity: show[index] === true ? 0.76 : 1.0 }">
